...
public class DoctorDetailsActivity extends AppCompatActivity {
    ...
    private final String[][] doctor_details3 =
            {
                    {"Doctor Name: Seema Patil", "Hospital Address: Pimpri", "Exp: 4yrs", "Mobile No:9898989898", "208"},
                    ...
                    {"Doctor Name: Shrikant Panda", "Hospital Address: Katraj", "Exp: 7yrs", "Mobile No:7798989898", "608"}
            };
    ...
    private final String[][] doctor_details5 =
            {
                    {"Doctor Name: Nilesh Borate", "Hospital Address: Pimpri", "Exp: 5yrs", "Mobile No: 9898989898", "1608"},
                    {"Doctor Name: Pankaj Pawar", "Hospital Address: Nigdi", "Exp: 15yrs", "Mobile No: 7898989898", "1900"},
                    {"Doctor Name: Swapnil Lele", "Hospital Address: Pune", "Exp: 8yrs", "Mobile No:8898989898", "1500"},
                    {"Doctor Name: Deepak Kumar", "Hospital Address: Chinchwad", "Exp: 6yrs", "Mobile No:9898000000", "1508"},
                    {"Doctor Name: Ankul Panda", "Hospital Address: Katraj", "Exp: 7yrs", "Mobile No: 7798989898", "1808"}
            };
    TextView tv;
    Button btn;
